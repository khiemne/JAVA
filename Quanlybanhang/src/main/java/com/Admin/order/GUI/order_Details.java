...
public class order_Details extends javax.swing.JFrame {
   ...
   private void initUI() {
    ...
    private void initComponents() {
        ...
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE); // Thay EXIT_ON_CLOSE bằng DISPOSE_ON_CLOSE
        setTitle("Order Details"); // Thêm tiêu đề cho cửa sổ
        setResizable(true); // Cho phép thay đổi kích thước

        bg.setBackground(new java.awt.Color(255, 255, 255));
        bg.setOpaque(true);

        // Đặt kích thước mới (rộng hơn và dài hơn)
        int width = 1400;  // Tăng chiều rộng từ 1369 lên 1400
        int height = 700;  // Tăng chiều cao từ 583 lên 700
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String customerID= Form_Order.customerID;
                String orderNo= Form_Order.orderNo;
