...
public class OTPFrame_cus extends javax.swing.JFrame {
         ...
         btnConfirm.addActionListener((e) -> {
            ...
            if (busAccount.ConfirmOTP(inputOTP)) {
                this.dispose();
                 ...
                 ResetPassword_cus reset = new ResetPassword_cus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OTPFrame_cus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OTPFrame_cus().setVisible(true);
            }
        });
    }
