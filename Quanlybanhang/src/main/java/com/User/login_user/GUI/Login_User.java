...
public class Login_User extends javax.swing.JFrame {
    ...
    private PanelCover_User cover;
    private PanelLoginandRegister_User LoginandRegister;
    ...
    private void init() {
        ...
        cover = new PanelCover_User();
        LoginandRegister = new PanelLoginandRegister_User();
